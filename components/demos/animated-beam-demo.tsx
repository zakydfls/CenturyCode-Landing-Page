...
const Circle = forwardRef<HTMLDivElement, { className?: string; children?: React.ReactNode }>(({ className, children }, ref) => {
  return (
    <div ref={ref} className={cn("z-10 flex size-12 items-center justify-center rounded-full border-2 border-border  p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]", className)}>
      {children}
    </div>
  );
});
...
export function AnimatedBeamMultipleOutputDemo({ className }: { className?: string }) {
  ...
  return (
    <div className={cn("relative flex xl:h-[500px] w-full items-center justify-center overflow-hidden  p-10 ", className)} ref={containerRef}>
      <div className="flex size-full flex-row items-stretch justify-between gap-10 max-w-lg">
        <div className="flex flex-col justify-center gap-2">
          <Circle ref={div1Ref}>
            <Image src={"/logo/gitlab.png"} width={10000} height={10000} className="w-6 h-6" alt="image" />
          </Circle>
          <Circle ref={div2Ref}>
            <Icons.googleDocs />
          </Circle>
          <Circle ref={div3Ref}>
            <Image src={"/logo/figma.png"} width={10000} height={10000} className="w-6 h-6" alt="image" />
          </Circle>
          <Circle ref={div4Ref}>
            <Image src={"/logo/vscode.png"} width={10000} height={10000} className="w-6 h-6" alt="image" />
          </Circle>
          <Circle ref={div5Ref}>
            <Icons.notion />
          </Circle>
        ...
        <div className="flex flex-col justify-center">
          <Circle ref={div6Ref} className="size-16 bg-white">
            <Image src={"/logo/century.png"} height={1000} width={1000} alt="logo" />
          </Circle>
        </div>
        <div className="flex flex-col justify-center">
