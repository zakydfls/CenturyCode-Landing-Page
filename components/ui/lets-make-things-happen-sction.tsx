  ...
  return (
    ...
    >
      <div className="md:pr-[22rem]">
        ...
        <p className="my-10 text-xl">Contact us today to learn more about how our services can help your business & governments grow and succeed online.</p>
      ...
      <div className="absolute -top-8 right-8 hidden md:block">
        <Image src="/images/proposal_illustration.png" alt="proposal illustration" width={300} height={300} />
      </div>
    </section>
  );
}
